...
pg_query($connect,"DELETE FROM friends WHERE userName = '$user' AND friend = '$removingFriend'")or die("Could not Connect");;
pg_query($connect,"DELETE FROM friends WHERE userName = '$removingFriend' AND friend = '$user'")or die("Could Not connect");;
